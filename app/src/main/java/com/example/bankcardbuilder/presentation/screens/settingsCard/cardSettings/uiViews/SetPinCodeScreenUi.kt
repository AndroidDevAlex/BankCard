...
import com.example.bankcardbuilder.presentation.screens.settingsCard.PinCodeCircles
...
import com.example.bankcardbuilder.presentation.screens.settingsCard.PinCodeKeyboard
...
fun SetPinCodeScreenUi(
    ...
    Column(
        ...
        TopBarCustom(
            ...
            onBackClicked = { actions.onBackClick() },
        ...
        Column(
            ...
            PinCodeKeyboard(pinCode = screenState.pinCode, onPinCodeChange = actions.onPinCodeChange)
